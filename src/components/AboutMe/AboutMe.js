        ...
        <div className="aboutme__info-container">
          <div>
            ...
            <p className="aboutme__text">
              ...
              МГАВМиБ. Я люблю играть в компьютерные игры, а ещё увлекаюсь
              финансами. Недавно опять начала разрабатывать сайты, как когда-то
              давно в школе. После того, как прошла курс по веб-разработке от
              Яндекс.Практикума, окончательно поняла что это "мое" и записалась
              на курсы миддл разработчика, для дальнейшего получения опыта и
              навыков.
            </p>
          </div>
          <a
